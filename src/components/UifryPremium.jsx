function UifryPremium() {
  return (
    <>
      <section className="container h-screen mx-auto lg:mt-72 mt-[350px] flex flex-col-reverse lg:flex-row items-center px-3 lg:px-0">
        ...
        <div className="flex-1 z-20 ">
          ...
          <div className="mt-5 text-lg mb-3 relative z-20">
            ...
            <p className="text-base font-medium dark:text-white text-gray-600 lg:w-4/5">
              Cum et convallis risus placerat aliquam, nunc. Scelerisque
              aliquots faucibus tincidunt eu adipiscing sociis arcu lorem
              porttitor.
            </p>
          </div>
          <div className="mt-5 text-lg mb-3 relative z-20">
